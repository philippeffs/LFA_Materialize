  ...
  <nav class="blue-grey darken-1 z-depth-4" role="navigation">
    <div class="nav-wrapper container">
      ...
      <ul id="nav-mobile" class="side-nav">
          ...
          <li><div class="divider"></div></li>
          <li class="bold"><a href="#!" class="waves-effect waves-light waves-grey">Linhas de Pesquisa</a></li>
          <li><div class="divider"></div></li>
          <li class="bold"><a href="#!" class="waves-effect waves-light waves-grey">Publicações</a></li>
          <li><div class="divider"></div></li>
          <li class="bold"><a href="#!" class="waves-effect waves-light waves-grey">Contato</a></li>
      </ul>
