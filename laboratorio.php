      ...
      <div class="row">
        <div class="col s12 m12 l12">
          <!--<div class="icon-block">-->
            ...
            <h5>O Laboratório</h5>
            <p class="light left">O laboratório foi projetado em um espaço interno de 110 metros quadrados e possui uma área externa de 150 metros quadrados para desenvolvimentos de pesquisas de graduação e pós-graduação. É equipado para atender demandas relacionadas a ensaios da Metodologia Marshall de acordo com a norma da Associação Brasileira de Normas Técnicas (ABNT) NBR 12891, além de possuir todo o aparato para realização de ensaios de agregados para pavimentação e de ligantes asfálticos. Também está equipado para a caracterização tecnológica de agregados para lastro ferroviário conforme a ABNT NBR 5564 e para a adequação de materiais alternativos como escórias siderúrgicas e rejeitos de mineração tanto para utilização em pavimentos rodoviários quanto para os ferroviários.</p>
          <!--</div>-->
        </div>
